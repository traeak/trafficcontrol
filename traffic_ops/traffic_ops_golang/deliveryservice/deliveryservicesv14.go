...
func (ds *TODeliveryServiceV14) V13() *TODeliveryServiceV13 {
	return &TODeliveryServiceV13{ReqInfo: ds.ReqInfo, DeliveryServiceNullableV13: ds.DeliveryServiceNullableV13}
}
...
func GetTypeV14Factory() api.CRUDFactory {
	return func(reqInfo *api.APIInfo) api.CRUDer {
		toReturn := TODeliveryServiceV14{reqInfo, tc.DeliveryServiceNullable{}}
		return &toReturn
	}
}
...
func CreateV14(w http.ResponseWriter, r *http.Request) {
	...
	if authorized, err := isTenantAuthorized(inf.User, inf.Tx, &ds.DeliveryServiceNullableV13); err != nil {
